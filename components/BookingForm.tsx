...
const BookingForm: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // In a real app, send data to backend or trigger WhatsApp link
    ...
    return (
      <section id="booking" className="py-24 bg-white">
        <div className="container mx-auto px-6 text-center">
            ...
            <h3 className="text-3xl font-serif text-stone-800 mb-4">Solicitação Enviada!</h3>
            ...
            <button 
                ...
                className="mt-8 text-rose-500 font-medium underline"
            >
        ...
        <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-rose-50 border-l-4 border-rose-500 p-6 mb-10 rounded-r-lg">
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        <h4 className="font-serif text-lg font-bold text-rose-900 mb-1">Informações Importantes</h4>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input 
                            ...
                            className="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded focus:outline-none focus:border-rose-400 focus:ring-1 focus:ring-rose-400 transition-colors"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input 
                            type="text" name="placement" required placeholder="Ex: Antebraço, Panturrilha..."
                            className="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded focus:outline-none focus:border-rose-400 focus:ring-1 focus:ring-rose-400 transition-colors"
                        ...
                        <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-stone-300 border-dashed rounded-lg cursor-pointer bg-stone-50 hover:bg-stone-100 transition-colors">
                            <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                ...
                                <p className="text-sm text-stone-500">
                                    {formData.referenceFile ? formData.referenceFile.name : "Clique para enviar imagem de referência"}
                                </p>
                            </div>
                ...
                <div className="flex items-start gap-3 mt-4">
                    <input 
                        ...
                        className="mt-1 w-4 h-4 text-rose-600 rounded border-stone-300 focus:ring-rose-500"
                    />
                    <label htmlFor="deposit" className="text-sm text-stone-600">
                ...
                <button 
                    type="submit"
                    className="w-full bg-stone-900 text-white py-4 rounded font-sans uppercase tracking-widest hover:bg-rose-600 transition-all duration-300 shadow-lg mt-6"
                >
                    Enviar Solicitação
                </button>
            </form>
