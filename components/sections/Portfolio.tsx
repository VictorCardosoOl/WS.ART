    ...
    <div ref={ref} className={`relative overflow-hidden w-full h-full ${className}`}>
      <motion.div style={{ y, scale }} className="w-full h-full">
        <img 
          ...
          alt={alt} 
          title={alt}
          className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-[1200ms] ease-out-expo group-hover:scale-105"
          loading="lazy"
        />
      </motion.div>
    </div>
...
const Portfolio: React.FC = () => {
  return (
    <section id="gallery" className="relative pt-40 pb-40 bg-white">
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="mt-48 text-center" data-cursor="EXPLORAR">
           <Reveal>
