...
const Hero: React.FC = () => {
  ...
  return (
    <section ref={containerRef} className="relative h-[100dvh] w-full overflow-hidden bg-[#FAF7F7] z-10 flex flex-col justify-between p-4 md:p-6">
      
      {/* FRAME BORDER (Leia Vallante Reference) - Moldura Interna */}
      <div className="absolute inset-4 md:inset-6 border border-[#754548]/20 pointer-events-none z-20 rounded-2xl md:rounded-3xl"></div>
      ...
      <div className="w-full max-w-[1920px] mx-auto px-6 md:px-12 lg:px-24 relative z-30 flex flex-col pt-32 md:pt-40 pointer-events-none flex-grow justify-between h-full">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start w-full">
              ...
              <div className="flex flex-col items-end text-right pointer-events-auto ml-auto max-w-xl pr-4 md:pr-12 pt-8 md:pt-0">
          ...
          <div className="w-full relative pb-12 flex flex-col items-center justify-end h-full">
             <div className="hero-fade animate-bounce duration-[3000ms] mb-8 opacity-50 absolute bottom-12">
                <ArrowDown size={18} className="text-[#754548]" />
             </div>
          </div>
      </div>

      {/* Massive Typography - Occupied Style (Behind Frame but visually dominant) */}
      <div 
        ref={titleRef}
      ...
      >
          <h1 className="font-sans font-black text-[22vw] text-[#12100E] tracking-tighter text-center leading-[0.7] w-full opacity-[0.95] overflow-hidden translate-y-[4%] md:translate-y-[2%]">
