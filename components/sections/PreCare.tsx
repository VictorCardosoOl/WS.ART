...
const PreCare: React.FC = () => {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // Cards Animation (Staggered pop-up with slight rotation)
  ...
  return (
    <section ref={containerRef} className="py-32 md:py-40 relative overflow-hidden bg-[#F5F5F5]" id="precare">
           ...
           {careItems.map((item, index) => (
               <div key={index} className="precare-card flex flex-col h-full group will-change-transform perspective-1000">
                 ...
                 <div className="flex items-center gap-3 mb-4">
                     ...
                     <span className="text-xs font-bold font-sans text-stone-400">0{index + 1}</span>
                 </div>
                 ...
                 <span className="text-sm text-stone-500 font-light mb-6 block font-sans tracking-wide">
                    {item.subtitle}
                 </span>
      ...
      {/* SEPARATOR: HAND DRAWN LINE (To Testimonials) */}
