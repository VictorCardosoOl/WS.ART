  ...
  return (
    <section ref={containerRef} className="py-32 md:py-40 bg-[#F5F5F5] text-stone-900 relative overflow-hidden" id="precare">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="mb-32 md:mb-48 mt-12 precare-title">
        ...
        <div className="precare-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-20">
           {careItems.map((item, index) => (
               <div key={index} className="precare-card flex flex-col h-full group">
                 ...
                 <div className="w-full h-[1px] bg-stone-300 mb-6 group-hover:bg-[#754548] transition-colors duration-500 origin-left transform group-hover:scale-x-100"></div>
