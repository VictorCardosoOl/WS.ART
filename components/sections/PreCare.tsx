  ...
  return (
    <section ref={containerRef} className="py-32 md:py-48 bg-[#F5F5F5] text-stone-900 relative overflow-hidden" id="precare">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        {/* Editorial Header */}
        <div className="mb-32 md:mb-40 mt-12">
            <span className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#754548] mb-6">Guia Essencial</span>
            <h2 className="font-sans font-medium text-7xl md:text-9xl tracking-tighter text-stone-900 leading-[0.8]">
                O Preparo
                <span className="block font-serif text-2xl md:text-5xl italic font-normal text-stone-400 mt-4 tracking-normal">
                    (antes da agulha)
                </span>
            </h2>
        </div>
