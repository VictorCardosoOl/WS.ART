        ...
        <div className="flex flex-col lg:flex-row gap-20 items-start">
          ...
          <div className="w-full lg:w-1/2" ref={listRef}>
             <div className="process-header mb-20">
               <span className="text-[10px] font-bold uppercase tracking-[0.25em] text-[#754548] mb-4 block">O Método</span>
               <h2 className="font-serif text-5xl md:text-7xl text-stone-900 leading-[0.9] tracking-tighter">
                  Processo Criativo<span className="text-[#754548]">.</span>
               </h2>
             </div>
            ...
            <div className="w-full lg:sticky lg:top-32 lg:pl-12 border-l border-[#754548]/10">
               <AnimatePresence mode='wait'>
                   <motion.div 
                     ...
                     className="relative"
                   >
                     <h4 className="font-serif text-[8rem] md:text-[12rem] text-[#754548] leading-none opacity-5 absolute -top-20 -left-10 select-none pointer-events-none">
                        {steps[activeStep].id}
                     </h4>
