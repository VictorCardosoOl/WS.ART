...
const Services: React.FC = () => {
  ...
  return (
    <section id="services" className="py-32 md:py-48 bg-stone-900 text-stone-100 overflow-hidden relative">
      <div className="w-full max-w-[1920px] mx-auto px-5 md:px-12 lg:px-20 relative z-20">
        ...
        <div className="flex flex-col lg:flex-row gap-20 lg:gap-32 relative">
          ...
          {/* List Section - Minimalismo Extremo (Sem Bordas) */}
                ...
                >
                  <div className="flex flex-col md:flex-row md:items-baseline justify-between gap-6">
                    <div className="flex items-baseline gap-8">
                        <span className="font-sans text-[10px] text-stone-600 font-bold tracking-widest opacity-60 group-hover:text-rose-500 group-hover:opacity-100 transition-all duration-500">0{index + 1}</span>
                    ...
                    {/* Descrição curta agora com muito respiro */}
