...
const FlashDay: React.FC = () => {
  return (
    <section id="flashday" className="py-24 md:py-32 bg-gradient-to-b from-white to-[#FAF7F7] border-b border-stone-100 relative overflow-hidden">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            <div className="relative">
                <Reveal delay={100}>
                    <div className="bg-white p-8 md:p-12 border border-stone-100 relative overflow-hidden group rounded-sm shadow-xl">
                        {/* Decorative Line */}
                        ...
                        <div className="mt-10">
                            <button className="w-full py-4 bg-[#754548] text-white font-sans text-[10px] font-bold uppercase tracking-[0.25em] hover:bg-stone-900 transition-colors flex justify-between items-center px-6">
