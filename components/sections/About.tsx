      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        <div ref={textRef} className="flex flex-col lg:flex-row justify-end mb-24 md:mb-32">
          <div className="lg:w-2/3 flex flex-col items-start text-left">
            ...
            {/* Headline Editorial */}
            <h2 className="font-serif font-bold text-fluid-h2 leading-[0.9] tracking-tighter text-stone-900 mb-10 uppercase">
            ...
            {/* Subtexto Descritivo - Satoshi Wide */}
            <div className="overflow-hidden mt-4 pl-2 border-l-2 border-pantone-accent">
                <p className="about-text-fade font-sans text-sm md:text-base text-stone-500 max-w-sm leading-relaxed font-normal tracking-wide">
        ...
        <div ref={imagesRef} className="relative">
           <div className="hidden lg:block absolute -left-8 top-0 text-4xl leading-none text-stone-900 about-text-fade font-serif">•</div>

           <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
              {[201, 202, 203].map((id, idx) => (
                <div key={id} className={`about-image-wrapper relative aspect-[3/4] overflow-hidden bg-stone-100 will-change-transform ${idx === 1 ? 'md:mt-16' : ''}`}>
                    <img 
