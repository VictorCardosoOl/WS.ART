      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            <div className="relative">
                ...
                <Reveal delay={100}>
                    <div className="bg-[#FAF7F7] p-8 md:p-12 border border-stone-100 relative overflow-hidden group">
                        {/* Decorative Line */}
                        ...
                        <div className="mt-10">
                            <button className="w-full py-4 bg-stone-900 text-white font-sans text-xs font-bold uppercase tracking-[0.2em] hover:bg-rose-800 transition-colors flex justify-between items-center px-6">
