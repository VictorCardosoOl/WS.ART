    ...
    <footer className="relative bg-black text-white pt-24 md:pt-32 pb-0 font-sans overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-x-12 gap-y-12 md:gap-y-16 border-b border-stone-800 pb-12 md:pb-16">
          ...
          <div className="lg:col-span-4 flex flex-col justify-between h-full">
            <div>
              <div className="flex items-center gap-3 mb-6 md:mb-8">
                <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-black font-serif font-bold text-xl flex-shrink-0">
                  W
                </div>
                <h3 className="text-xs font-bold tracking-widest uppercase leading-tight text-stone-300 font-sans">
                  INTERVENÇÕES ARTÍSTICAS ÚNICAS //<br/>
                  EXPERIÊNCIAS IMERSIVAS
                </h3>
              </div>
              
              <p className="text-stone-500 text-sm leading-relaxed max-w-sm mb-8 md:mb-12 font-sans">
            ...
            <div className="space-y-4 text-sm text-stone-400 font-sans">
          ...
          <div className="lg:col-span-4 flex flex-col">
            {[
              ...
              >
                <span className="tracking-[0.2em] uppercase text-xs font-bold text-stone-300 group-hover:text-white font-sans">{link.name}</span>
             ...
             <a 
              ...
              >
                <span className="tracking-[0.2em] uppercase text-xs font-bold text-white font-sans">ENTRE EM CONTATO</span>
          ...
          {/* Column 3: CTA */}
          <div className="lg:col-span-4 flex flex-col">
            <h2 className="text-3xl md:text-5xl font-serif text-white leading-[1.1] mb-4 md:mb-6 uppercase">
            ...
            <div className="mt-auto flex justify-start md:justify-end">
               ...
               >
                 <span className="uppercase tracking-widest text-xs font-bold font-sans">Iniciar conversa</span>
        ...
        <div className="pt-10 md:pt-12 flex flex-col md:flex-row items-end justify-between relative">
          ...
          {/* Small Links Grid */}
          <div className="grid grid-cols-2 gap-x-8 gap-y-3 text-[10px] uppercase tracking-wider text-stone-500 mb-12 md:mb-16 w-full md:w-auto relative z-10 font-sans">
          ...
          <div className="w-full text-right relative h-auto overflow-visible pb-2 md:pb-4">
             ...
             <h1 className="text-[17vw] leading-[0.75] font-black text-white tracking-tighter mix-blend-difference select-none pointer-events-none translate-y-[5%] font-serif">
               SIQUEIRA
             </h1>
             <div className="absolute bottom-6 md:bottom-12 left-0 md:left-auto md:right-0 w-full md:w-auto text-center md:text-right z-20">
                <p className="text-[9px] md:text-[10px] uppercase tracking-widest text-stone-600 font-sans">© 2024 William Siqueira Art Ltd.</p>
             </div>
          </div>
        </div>
