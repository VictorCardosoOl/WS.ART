...
const Footer: React.FC = () => {
    ...
    return (
        <footer ref={footerRef} className="relative bg-stone-950 text-stone-400 overflow-hidden font-sans border-t border-stone-900">
            ...
            <div className="w-full max-w-screen-2xl mx-auto px-6 md:px-12 lg:px-24 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 border-l border-r border-stone-800/50">
                    ...
                    {/* COLUNA 1: IDENTIDADE */}
                    <div className="footer-col p-12 border-b lg:border-b-0 border-stone-800/50 flex flex-col justify-between h-full min-h-[300px]">
                        <div>
                    ...
                    {/* COLUNA 2: LOCAL & CTA */}
                    <div className="footer-col p-12 border-b lg:border-b-0 lg:border-l border-stone-800/50 flex flex-col justify-between h-full min-h-[300px]">
                        <div>
                    ...
                    {/* COLUNA 3: SOCIAL */}
                    <div className="footer-col p-12 border-b md:border-b-0 lg:border-l border-stone-800/50 flex flex-col h-full min-h-[300px]">
                        ...
                        <div className="flex flex-col gap-6">
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="flex items-center gap-4 text-stone-400 hover:text-white transition-colors group will-change-transform"
                            >
                    ...
                    <div className="footer-col p-12 lg:border-l border-stone-800/50 flex flex-col justify-between h-full min-h-[300px]">
                        <div>
                            <p className="text-[10px] uppercase tracking-widest text-stone-600 mb-8">
                                Menu
                            </p>
